...
namespace Microsoft.Azure.Management.Storage
{
    ...
    internal partial class BlobContainersOperations : IServiceOperations<StorageManagementClient>, IBlobContainersOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse> VersionLevelWormMethodWithHttpMessagesAsync(string resourceGroupName, string accountName, string containerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse _response = await BeginVersionLevelWormMethodWithHttpMessagesAsync(resourceGroupName, accountName, containerName, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> BeginVersionLevelWormMethodWithHttpMessagesAsync(string resourceGroupName, string accountName, string containerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("containerName", containerName);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "BeginVersionLevelWormMethod", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
