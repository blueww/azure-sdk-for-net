...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public partial interface IBlobContainersOperations
    {
        ...
        /// to version level WORM enabled container. Prerequisites require a
        /// container level immutability policy either in locked or unlocked
        /// state, Account level versioning must be enabled and there should be
        /// no Legal holds.
        /// </summary>
        /// <param name='resourceGroupName'>
        /// The name of the resource group within the user's subscription. The
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> VersionLevelWormMethodWithHttpMessagesAsync(string resourceGroupName, string accountName, string containerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// This operation migrates a blob container from container level WORM
        /// to version level WORM enabled container. Prerequisites require a
        /// container level immutability policy either in locked or unlocked
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> BeginVersionLevelWormMethodWithHttpMessagesAsync(string resourceGroupName, string accountName, string containerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Lists all containers and does not support a prefix like data plane.
        /// Also SRP today does not return continuation token.
        /// </summary>
