    ...
    public class BlobServiceTests
    {
        ...
        public void BlobServiceTest()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType().FullName))
            {
                ...
                try
                {
                    BlobServiceProperties properties1 = storageMgmtClient.BlobService.GetServiceProperties(rgName, accountName);
                    ...
                    storageMgmtClient.BlobService.SetServiceProperties(rgName, accountName, properties2);
                    BlobServiceProperties properties3 = storageMgmtClient.BlobService.GetServiceProperties(rgName, accountName);
        ...
        public void BlobServiceCorsTest()
        {
            ...
            using (MockContext context = MockContext.Start(this.GetType().FullName))
            {
                ...
                try
                {
                    ...
                    BlobServiceProperties properties3 = storageMgmtClient.BlobService.SetServiceProperties(rgName, accountName, properties2);
                    Assert.True(properties3.DeleteRetentionPolicy.Enabled);
                    Assert.Equal(300, properties3.DeleteRetentionPolicy.Days);
                    Assert.Equal("2017-04-17", properties3.DefaultServiceVersion);
                    ...
                    BlobServiceProperties properties4 = storageMgmtClient.BlobService.GetServiceProperties(rgName, accountName);
